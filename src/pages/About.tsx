    ...
    <div className="min-h-screen">
      ...
      <div className="container max-w-6xl mx-auto py-8 sm:py-12 px-4 space-y-12 sm:space-y-16">
          ...
          <motion.section
            ...
            transition={{ duration: 0.6 }}
          >
            <Card className="border-2 bg-gradient-to-br from-primary/5 to-transparent hover-lift">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <Card className="border-2 hover-lift smooth-transition h-full">
                  <CardContent className="p-8">
                    <motion.div 
          ...
          <motion.section
            ...
            transition={{ duration: 0.6 }}
          >
            <Card className="border-2 bg-gradient-to-br from-green-50 to-transparent dark:from-green-950/20 hover-lift">
              <CardContent className="p-8">
                <motion.div 
                  className="w-14 h-14 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center mb-4"
                  whileHover={{ scale: 1.1, rotate: -5 }}
                >
